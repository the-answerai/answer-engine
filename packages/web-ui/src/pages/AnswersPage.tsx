...
export function AnswersPage() {
  ...
  function submit(event: FormEvent) { event.preventDefault(); void ask.mutateAsync({ question: question.trim(), ...(libraryId ? { libraryId } : {}), filters: { ...(contentType ? { contentTypes: [contentType] } : {}), ...(tag ? { tagSlugs: [tag] } : {}) } }); }
